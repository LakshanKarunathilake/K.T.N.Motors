...
public class InvoiceSearch {
    ...
    public InvoiceSearch(JTextField invoice_txt, JComboBox salesRepNameCombo, JComboBox customerID_combo, JComboBox customerName_combo, JTable table, JTextField totalTxt, JTextField discountTxt, JTextField grandTxt, JTextField additionalNoteTxt, DataBaseConnector connector) {
        this.invoice_txt = invoice_txt;
        this.customerID_combo = customerID_combo;
        this.customerName_combo = customerName_combo;
        this.salesRepNameCombo = salesRepNameCombo;
        this.table = table;
    ...
    public void fillInvoice(String invoiceID) {
        ...
        salesRepNameCombo.setSelectedItem(connector.getRelavantRecord("invoices", "repName", "invoice_id", invoiceID));
