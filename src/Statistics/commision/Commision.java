...
//            credit = "0.00";
    ...
    public String getPartPayments() {
        String sql = "SELECT sum(credit_payments.amount) as val FROM credit_payments WHERE credit_payments.paid_date BETWEEN '" + date_begin + "' AND '" + date_end + "' AND credit_payments.invoice_id in (Select invoice_id from invoices where repName like '" + repName + "')";
